...
<html>
    ...
    <body id="login">
        <div class="container" className='d-flex justify-content-center align-items-center'>
            <div class="mt-5">
                <h1 class="text-center">Housing Society Management System</h1>
            ...
            <div class="credits">
                All Rights Reserved by Developers <a href="https://github.com/samaha-rizvi-4578/Housify" style="color: black; font-size: 12px; text-decoration: underline black 1px;"><b>Madeeha and iqra</b></a>
        </div>
        </div>
